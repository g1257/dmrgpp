...
#define LOKI_TYPELIST_4(T1, T2, T3, T4) ::Loki::Typelist<T1, LOKI_TYPELIST_3(T2, T3, T4)>

#define LOKI_TYPELIST_5(T1, T2, T3, T4, T5) ::Loki::Typelist<T1, LOKI_TYPELIST_4(T2, T3, T4, T5)>
