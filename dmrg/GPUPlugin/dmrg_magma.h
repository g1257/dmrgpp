...
void magmablas_Xgemm_vbatched_max_nocheck(
    ...
    magma_IntegerType_t* m, magma_IntegerType_t* n, magma_IntegerType_t* k,
    double alpha,
    double const * const * dA_array, magma_IntegerType_t* ldda,
    double const * const * dB_array, magma_IntegerType_t* lddb,
    double beta,
    double **dC_array, magma_IntegerType_t* lddc, 
    magma_IntegerType_t batchCount, 
    magma_IntegerType_t max_m, magma_IntegerType_t max_n, magma_IntegerType_t max_k, 
    magma_queue_t queue ) {
...
void magmablas_Xgemm_vbatched_max_nocheck(
    ...
    magma_IntegerType_t* m, magma_IntegerType_t* n, magma_IntegerType_t* k,
    float alpha,
    float const * const * dA_array, magma_IntegerType_t* ldda,
    float const * const * dB_array, magma_IntegerType_t* lddb,
    float beta,
    float **dC_array, magma_IntegerType_t* lddc, 
    magma_IntegerType_t batchCount, 
    magma_IntegerType_t max_m, magma_IntegerType_t max_n, magma_IntegerType_t max_k, 
    magma_queue_t queue ) {
...
void magmablas_Xgemm_vbatched_max_nocheck(
    ...
    magmaDoubleComplex const * const * dA_array, magma_IntegerType_t* ldda,
    magmaDoubleComplex const * const * dB_array, magma_IntegerType_t* lddb,
    magmaDoubleComplex beta,
    magmaDoubleComplex **dC_array, magma_IntegerType_t* lddc, 
    magma_IntegerType_t batchCount, 
    magma_IntegerType_t max_m, magma_IntegerType_t max_n, magma_IntegerType_t max_k, 
    magma_queue_t queue ) {
...
void magmablas_Xgemm_vbatched_max_nocheck(
    ...
    magmaFloatComplex const * const * dA_array, magma_IntegerType_t* ldda,
    magmaFloatComplex const * const * dB_array, magma_IntegerType_t* lddb,
    magmaFloatComplex beta,
    magmaFloatComplex **dC_array, magma_IntegerType_t* lddc, 
    magma_IntegerType_t batchCount, 
    magma_IntegerType_t max_m, magma_IntegerType_t max_n, magma_IntegerType_t max_k, 
    magma_queue_t queue ) {
...
void magmablas_Xgemm_vbatched(
    ...
    magmaDoubleComplex beta,
    magmaDoubleComplex **dC_array, magma_IntegerType_t* lddc, 
    magma_IntegerType_t batchCount, magma_queue_t queue ) {
...
static
void magma_Xgetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       double *dA_src, magma_IntegerType_t ldda,
                       double *hB_dst, magma_IntegerType_t ldb,
                       magma_queue_t queue ) {
...
static
void magma_Xgetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       float *dA_src, magma_IntegerType_t ldda,
                       float *hB_dst, magma_IntegerType_t ldb,
                       magma_queue_t queue ) {
...
static
void magma_Xgetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       magmaFloatComplex *dA_src, magma_IntegerType_t ldda,
                       magmaFloatComplex *hB_dst, magma_IntegerType_t ldb,
                       magma_queue_t queue ) {
...
static
void magma_Xgetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       magmaDoubleComplex *dA_src, magma_IntegerType_t ldda,
                       magmaDoubleComplex *hB_dst, magma_IntegerType_t ldb,
                       magma_queue_t queue ) {
...
static
void magma_Xsetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       magmaDoubleComplex const *hA_src, magma_IntegerType_t lda,
                       magmaDoubleComplex *dB_dst, magma_IntegerType_t lddb,
                       magma_queue_t queue ) {
...
static
void magma_Xsetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       magmaFloatComplex const *hA_src, magma_IntegerType_t lda,
                       magmaFloatComplex *dB_dst, magma_IntegerType_t lddb,
                       magma_queue_t queue ) {

     magma_csetmatrix( m, n, 
                       hA_src, lda,
                       dB_dst, lddb,
                       queue );
}
...
static
void magma_Xsetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       float const *hA_src, magma_IntegerType_t lda,
                       float *dB_dst, magma_IntegerType_t lddb,
                       magma_queue_t queue ) {
...
static
void magma_Xsetmatrix( magma_IntegerType_t m, magma_IntegerType_t n,
                       double const *hA_src, magma_IntegerType_t lda,
                       double *dB_dst, magma_IntegerType_t lddb,
                       magma_queue_t queue ) {
...
static
void magma_Xgetvector( magma_IntegerType_t n,
                       double *dA_src, magma_IntegerType_t ldda,
                       double *hB_dst, magma_IntegerType_t ldb,
                       magma_queue_t queue ) {
...
static
void magma_Xsetvector( magma_IntegerType_t n,
                       magmaDoubleComplex const *hA_src, magma_IntegerType_t incx,
                       magmaDoubleComplex *dB_dst, magma_IntegerType_t incy,
                       magma_queue_t queue ) {
...
static
void magma_Xsetvector( magma_IntegerType_t n,
                       magmaFloatComplex const *hA_src, magma_IntegerType_t incx,
                       magmaFloatComplex *dB_dst, magma_IntegerType_t incy,
                       magma_queue_t queue ) {
...
static
void magma_Xsetvector( magma_IntegerType_t n,
                       float const *hA_src, magma_IntegerType_t incx,
                       float *dB_dst, magma_IntegerType_t incy,
                       magma_queue_t queue ) {
...
static
void magma_Xsetvector( magma_IntegerType_t n,
                       double const *hA_src, magma_IntegerType_t incx,
                       double *dB_dst, magma_IntegerType_t incy,
                       magma_queue_t queue ) {
