...
=pod
 ...
 First non-whitespace character after mode, if it is a ( in the same line
 Last  non-whitespace character in a line, if it is a )
 First non-whitespace character in a line, if it is a <
