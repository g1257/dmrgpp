...
// ----------------------------
template<typename T, int const nb = 128>
void GEMMR_template(char const transA, char const transB, 
	...
	//  -------------------------
	int const nblocks_i = (m + (nb-1))/nb;
	int const nblocks_j = (n + (nb-1))/nb;
	...
	/*
	* ----------------------------------------
	* check whether OpenMP "task" is supported
	* ----------------------------------------
	*/
#pragma omp single
#else
...
inline void GEMMR(char const transA,char const  transB,
                  int const m, int const n, int const k,
                  double const &alpha,
                  double const * const A, int const ldA,
                  double const * const B, int const ldB,
                  double const &beta,
                  double       * const C, int const ldC ) {
	GEMMR_template<double>( transA, transB,
	                        m,n,k,
	                        alpha,
	                        A, ldA,
	                        B, ldB,
...
inline void GEMMR(char const transA,char const  transB,
                  int const m, int const n, int const k,
                  float const &alpha,
                  float const * const A, int const ldA,
                  float const * const B, int const ldB,
                  float const &beta,
                  float       * const C, int const ldC ) {

	GEMMR_template<float>( transA, transB,
	                       m,n,k,
	                       alpha,
	                       A, ldA,
	                       B, ldB,
...
inline void GEMMR(char const transA,char const  transB,
                  ...
                  std::complex<double> const * const A, int const ldA,
                  std::complex<double> const * const B, int const ldB,
                  std::complex<double> const &beta,
                  std::complex<double>       * const C, int const ldC ) {

	GEMMR_template<std::complex<double>>( transA, transB,
	                                      m,n,k,
	                                      alpha,
	                                      A, ldA,
	                                      B, ldB,
...
inline void GEMMR(char const transA,char const  transB,
                  ...
                  std::complex<float> const * const A, int const ldA,
                  std::complex<float> const * const B, int const ldB,
                  std::complex<float> const &beta,
                  std::complex<float>       * const C, int const ldC ) {

	GEMMR_template<std::complex<float>>( transA, transB,
	                                     m,n,k,
	                                     alpha,
	                                     A, ldA,
	                                     B, ldB,
