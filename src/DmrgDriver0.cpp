...
typedef Dmrg::MatrixVectorOnTheFly<
	...
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance0Type>>, Dmrg::Basis<SparseMatrixInstance0Type>>>,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance0Type::RealType>,
    MatrixVector0Type,
    MatrixVector0Type::VectorType>
    LanczosSolver0Type;

template void mainLoop4<LanczosSolver0Type, Dmrg::VectorWithOffset<RealType, Dmrg::Qn>>(LanczosSolver0Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef Dmrg::MatrixVectorStored<
    Dmrg::ModelBase<
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance1Type>>, Dmrg::Basis<SparseMatrixInstance1Type>>>,
	ParametersDmrgSolverType,
	InputNgType::Readable,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance1Type::RealType>,
    MatrixVector1Type,
    MatrixVector1Type::VectorType>
    LanczosSolver1Type;

template void mainLoop4<LanczosSolver1Type, Dmrg::VectorWithOffset<RealType, Dmrg::Qn>>(LanczosSolver1Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
