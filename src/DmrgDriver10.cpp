...
typedef Dmrg::MatrixVectorKron<
	...
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance20Type>>, Dmrg::Basis<SparseMatrixInstance20Type>>>,
...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance20Type::RealType>,
    MatrixVector20Type,
    MatrixVector20Type::VectorType>
    LanczosSolver20Type;

template void mainLoop4<LanczosSolver20Type, Dmrg::VectorWithOffset<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver20Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef Dmrg::MatrixVectorOnTheFly<
    Dmrg::ModelBase<
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance21Type>>, Dmrg::Basis<SparseMatrixInstance21Type>>>,
	ParametersDmrgSolverType,
	InputNgType::Readable,
...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance21Type::RealType>,
    MatrixVector21Type,
    MatrixVector21Type::VectorType>
    LanczosSolver21Type;

template void mainLoop4<LanczosSolver21Type, Dmrg::VectorWithOffsets<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver21Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
