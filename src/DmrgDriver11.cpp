...
typedef Dmrg::MatrixVectorStored<
	...
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance22Type>>, Dmrg::Basis<SparseMatrixInstance22Type>>>,
...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance22Type::RealType>,
    MatrixVector22Type,
    MatrixVector22Type::VectorType>
    LanczosSolver22Type;

template void mainLoop4<LanczosSolver22Type, Dmrg::VectorWithOffsets<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver22Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef Dmrg::MatrixVectorKron<
    Dmrg::ModelBase<
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance23Type>>, Dmrg::Basis<SparseMatrixInstance23Type>>>,
	ParametersDmrgSolverType,
	InputNgType::Readable,
...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance23Type::RealType>,
    MatrixVector23Type,
    MatrixVector23Type::VectorType>
    LanczosSolver23Type;

template void mainLoop4<LanczosSolver23Type, Dmrg::VectorWithOffsets<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver23Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
