...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance28Type::RealType>,
    MatrixVector28Type,
    MatrixVector28Type::VectorType>
    LanczosSolver28Type;

template void mainLoop4<LanczosSolver28Type, Dmrg::VectorWithOffsets<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver28Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance29Type::RealType>,
    MatrixVector29Type,
    MatrixVector29Type::VectorType>
    LanczosSolver29Type;

template void mainLoop4<LanczosSolver29Type, Dmrg::VectorWithOffsets<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver29Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
