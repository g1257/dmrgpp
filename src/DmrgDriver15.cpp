...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance30Type::RealType>,
    MatrixVector30Type,
    MatrixVector30Type::VectorType>
    LanczosSolver30Type;

template void mainLoop4<LanczosSolver30Type, Dmrg::VectorWithOffset<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver30Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance31Type::RealType>,
    MatrixVector31Type,
    MatrixVector31Type::VectorType>
    LanczosSolver31Type;

template void mainLoop4<LanczosSolver31Type, Dmrg::VectorWithOffset<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver31Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
