...
typedef Dmrg::MatrixVectorOnTheFly<
 Dmrg::ModelBase<
  Dmrg::ModelHelperLocal<
   Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Operators<Dmrg::Basis<SparseMatrixInstance36Type,CvectorSizeType> >  >,Dmrg::Basis<SparseMatrixInstance36Type,CvectorSizeType> >
  >,
...
template void mainLoop4<LanczosSolver36Type,Dmrg::VectorWithOffset<std::complex<RealType> > >
(LanczosSolver36Type::LanczosMatrixType::ModelType::GeometryType&,
...
typedef Dmrg::MatrixVectorStored<
 Dmrg::ModelBase<
  Dmrg::ModelHelperLocal<
   Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Operators<Dmrg::Basis<SparseMatrixInstance37Type,CvectorSizeType> >  >,Dmrg::Basis<SparseMatrixInstance37Type,CvectorSizeType> >
  >,
  ParametersDmrgSolverType,
  InputNgType::Readable,
...
template void mainLoop4<LanczosSolver37Type,Dmrg::VectorWithOffset<std::complex<RealType> > >
(LanczosSolver37Type::LanczosMatrixType::ModelType::GeometryType&,
const ParametersDmrgSolverType&,
InputNgType::Readable&,
const OperatorOptions&,
PsimagLite::String);
