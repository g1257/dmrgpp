...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance6Type::RealType>,
    MatrixVector6Type,
    MatrixVector6Type::VectorType>
    LanczosSolver6Type;

template void mainLoop4<LanczosSolver6Type, Dmrg::VectorWithOffset<RealType, Dmrg::Qn>>(LanczosSolver6Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef PsimagLite::ChebyshevSolver<PsimagLite::ParametersForSolver<GeometryInstance7Type::RealType>,
    MatrixVector7Type,
    MatrixVector7Type::VectorType>
    LanczosSolver7Type;

template void mainLoop4<LanczosSolver7Type, Dmrg::VectorWithOffset<RealType, Dmrg::Qn>>(LanczosSolver7Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
