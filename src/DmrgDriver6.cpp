...
typedef Dmrg::MatrixVectorOnTheFly<
	...
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance12Type>>, Dmrg::Basis<SparseMatrixInstance12Type>>>,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance12Type::RealType>,
    MatrixVector12Type,
    MatrixVector12Type::VectorType>
    LanczosSolver12Type;

template void mainLoop4<LanczosSolver12Type, Dmrg::VectorWithOffset<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver12Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef Dmrg::MatrixVectorStored<
    Dmrg::ModelBase<
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance13Type>>, Dmrg::Basis<SparseMatrixInstance13Type>>>,
	ParametersDmrgSolverType,
	InputNgType::Readable,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance13Type::RealType>,
    MatrixVector13Type,
    MatrixVector13Type::VectorType>
    LanczosSolver13Type;

template void mainLoop4<LanczosSolver13Type, Dmrg::VectorWithOffset<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver13Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
