...
typedef Dmrg::MatrixVectorKron<
	...
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance14Type>>, Dmrg::Basis<SparseMatrixInstance14Type>>>,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance14Type::RealType>,
    MatrixVector14Type,
    MatrixVector14Type::VectorType>
    LanczosSolver14Type;

template void mainLoop4<LanczosSolver14Type, Dmrg::VectorWithOffset<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver14Type::MatrixType::ModelType::SuperGeometryType&,
...
typedef Dmrg::MatrixVectorOnTheFly<
    Dmrg::ModelBase<
	Dmrg::ModelHelperLocal<
	    Dmrg::LeftRightSuper<Dmrg::BasisWithOperators<Dmrg::Basis<SparseMatrixInstance15Type>>, Dmrg::Basis<SparseMatrixInstance15Type>>>,
	ParametersDmrgSolverType,
	InputNgType::Readable,
...
typedef PsimagLite::LanczosSolver<PsimagLite::ParametersForSolver<GeometryInstance15Type::RealType>,
    MatrixVector15Type,
    MatrixVector15Type::VectorType>
    LanczosSolver15Type;

template void mainLoop4<LanczosSolver15Type, Dmrg::VectorWithOffsets<std::complex<RealType>, Dmrg::Qn>>(LanczosSolver15Type::MatrixType::ModelType::SuperGeometryType&,
    const ParametersDmrgSolverType&,
    InputNgType::Readable&,
    const OperatorOptions&);
