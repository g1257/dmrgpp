...
template void mainLoop4<LanczosSolver18Type,Dmrg::VectorWithOffset<RealType, Dmrg::Qn> >
...
template void mainLoop4<LanczosSolver19Type,Dmrg::VectorWithOffset<RealType, Dmrg::Qn> >
