				...
				for (nrow_A = 1; nrow_A <= 10; nrow_A += 3) {
					for (ncol_B = 1; ncol_B <= 10; ncol_B += 3) {
						for (nrow_B = 1; nrow_B <= 10; nrow_B += 3) {
							...
							den_kron_form(nrow_A, ncol_A, a_, nrow_B, ncol_B, b_, c_);
							...
							den_submatrix(nrow_C, ncol_C, c_, nrindex, ncindex, rindex, cindex, d_);
							/*
							 * -------------------------------------
							...
							den_kron_submatrix(nrow_A, ncol_A, a_, nrow_B, ncol_B, b_, nrindex, ncindex, rindex, cindex, e_);
