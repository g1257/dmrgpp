...
void csr_den_kron_mult_method<std::complex<double> >(const int imethod,
                              ...
                              const typename PsimagLite::Vector<std::complex<double> >::Type& yin_,
                              SizeType offsetY ,
                              typename PsimagLite::Vector<std::complex<double> >::Type& xout_,
                              SizeType offsetX);

template
int csr_nnz<std::complex<double> >(const PsimagLite::CrsMatrix<std::complex<double> >&);

template
bool csr_is_eye<std::complex<double> >(const PsimagLite::CrsMatrix<std::complex<double> >&);

template
bool csr_is_zeros<std::complex<double> >(const PsimagLite::CrsMatrix<std::complex<double> >&);
...
void den_csr_kron_mult_method<std::complex<double> >(const int imethod,
                              ...
                              const PsimagLite::CrsMatrix<std::complex<double> >& b,
                              const typename PsimagLite::Vector<std::complex<double> >::Type& yin,
                              SizeType offsetY,
                              typename PsimagLite::Vector<std::complex<double> >::Type& xout_,
                              SizeType offsetX);
...
void den_kron_mult_method<std::complex<double> >(const int imethod,
                          ...
                          const typename PsimagLite::Vector<std::complex<double> >::Type& yin,
                          SizeType offsetY ,
                          typename PsimagLite::Vector<std::complex<double> >::Type& xout,
                          SizeType offsetX);
