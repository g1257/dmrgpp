...
template void csr_den_kron_mult_method<std::complex<RealType>>(const int imethod,
    const char transA,
    const char transB,
...
template bool csr_is_eye<std::complex<RealType>>(const PsimagLite::CrsMatrix<std::complex<RealType>>&);

template void csr_transpose<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const int arowptr[],
    const int acol[],
...
template void csr_kron_mult_method<std::complex<RealType>>(const int imethod,
    const char transA,
    const char transB,
...
template void csr_matmul_post<std::complex<RealType>>(const char trans_A,
...
template void csr_matmul_pre<std::complex<RealType>>(const char trans_A,
    const PsimagLite::CrsMatrix<std::complex<RealType>>&,
    const int nrow_Y,
    const int ncol_Y,
    const PsimagLite::MatrixNonOwned<const std::complex<RealType>>& yin,
...
template void csr_submatrix<std::complex<RealType>>(const PsimagLite::CrsMatrix<std::complex<RealType>>& a,
    const int nrow_B,
    const int ncol_B,
    const int max_nnz,
...
template void csr_eye<std::complex<RealType>>(const int nrow_B,
    const int ncol_B,
    PsimagLite::CrsMatrix<std::complex<RealType>>& b);

template void csr_kron_submatrix<std::complex<RealType>>(const PsimagLite::CrsMatrix<std::complex<RealType>>& a,
    const PsimagLite::CrsMatrix<std::complex<RealType>>& b,
    const int nrindex,
    const int ncindex,
    const int max_nnz,
...
template void csc_matmul_pre<std::complex<RealType>>(const char trans_A,
    const int nrow_A,
    const int ncol_A,
...
template void csc_matmul_post<std::complex<RealType>>(const char trans_A,
    const int nrow_A,
    const int ncol_A,
    const PsimagLite::Vector<int>::Type& acolptr,
    const PsimagLite::Vector<int>::Type& arow,
...
template void csc_kron_mult_method<std::complex<RealType>>(const int imethod,
    const int nrow_A,
    const int ncol_A,
    const PsimagLite::Vector<int>::Type& acolptr,
    const PsimagLite::Vector<int>::Type& arow,
...
template void csc_kron_mult<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const PsimagLite::Vector<int>::Type& acolptr,
    const PsimagLite::Vector<int>::Type& arow,
    const PsimagLite::Vector<std::complex<RealType>>::Type&,
    const int nrow_B,
    const int ncol_B,
    const PsimagLite::Vector<int>::Type& bcolptr,
    const PsimagLite::Vector<int>::Type& brow,
...
template void coord2csr<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const int nnz,
    const int ilist[],
    const int jlist[],
...
template void den_csr_kron_mult_method<std::complex<RealType>>(const int imethod,
    const char transA,
    const char transB,
...
template void den_zeros<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    PsimagLite::Matrix<std::complex<RealType>>& a_);

template void den_transpose<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const std::complex<RealType> a_[],
    std::complex<RealType> at_[]);

template void den_gen_matrix<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const RealType& threshold,
    PsimagLite::Matrix<std::complex<RealType>>& a_);

template void den_matmul_pre<std::complex<RealType>>(const char trans_A,
    const int nrow_A,
    const int ncol_A,
    const PsimagLite::Matrix<std::complex<RealType>>& a_,
    const int nrow_Y,
...
template void den_matmul_post<std::complex<RealType>>(const char trans_A,
    const int nrow_A,
    const int ncol_A,
    const PsimagLite::Matrix<std::complex<RealType>>& a_,
    const int nrow_Y,
...
template void den_kron_submatrix<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const PsimagLite::Matrix<std::complex<RealType>>& a_,
    const int nrow_B,
    const int ncol_B,
...
template void den_kron_mult_method<std::complex<RealType>>(const int imethod,
    const char transA,
    const char transB,
    const PsimagLite::Matrix<std::complex<RealType>>& a_,
    const PsimagLite::Matrix<std::complex<RealType>>& b_,
...
template int den_nnz<std::complex<RealType>>(const PsimagLite::Matrix<std::complex<RealType>>&);

template bool den_is_eye<std::complex<RealType>>(const PsimagLite::Matrix<std::complex<RealType>>&);

template bool den_is_zeros<std::complex<RealType>>(const PsimagLite::Matrix<std::complex<RealType>>&);

template void den_kron_form<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const PsimagLite::Matrix<std::complex<RealType>>& a_,
    const int nrow_B,
    const int ncol_B,
...
template void den_kron_form_general<std::complex<RealType>>(
    const char transA,
    const char transB,
    const int nrow_A,
    const int ncol_A,
...
template void den_submatrix<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    const PsimagLite::Matrix<std::complex<RealType>>& a_,
    const int nrindex,
    const int ncindex,
...
template void den_eye<std::complex<RealType>>(const int nrow_A,
    const int ncol_A,
    PsimagLite::Matrix<std::complex<RealType>>& c_);
